...
import com.almaorient.unibo.almaorienteering.PianoStudi.DettaglioCorsoPagerAdapter;
import com.almaorient.unibo.almaorienteering.PianoStudi.NewPianoStudiModel;
import com.almaorient.unibo.almaorienteering.PianoStudi.ThreeLevelExpandableListView;
import com.almaorient.unibo.almaorienteering.strutturaUnibo.Scuola;
import com.almaorient.unibo.almaorienteering.versus.VersusActivity;
...
public class DettagliCorsoActivity extends BaseActivity implements ThreeLevelExpandableListView.Listener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                if(mSeconlevelmap == null && !haveNetworkConnection()){
                    finish();
                    Toast.makeText(getApplicationContext(),
